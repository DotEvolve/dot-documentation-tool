  ...
  it('should generate documentation for Prisma operations', () => {
    const element: CodeElement = {
      ...
      signature: {
        name: 'createWorkflow',
        parameters: [
          { name: 'data', type: 'WorkflowData', optional: false }
        ],
        isAsync: true,
  ...
  it('should generate documentation for business logic', () => {
    const element: CodeElement = {
      ...
      signature: {
        name: 'validateWorkflowRules',
        parameters: [
          { name: 'workflow', type: 'Workflow', optional: false }
        ],
        isAsync: false,
  ...
  it('should generate documentation for PDF generation', () => {
    const element: CodeElement = {
      ...
      signature: {
        name: 'generatePDFReport',
        parameters: [
          { name: 'data', type: 'ReportData', optional: false }
        ],
        isAsync: true,
  ...
  it('should generate documentation for payload validation', () => {
    const element: CodeElement = {
      ...
      signature: {
        name: 'validateWebhookPayload',
        parameters: [
          { name: 'payload', type: 'any', optional: false }
        ],
        isAsync: false,
        returnType: 'ValidationResult'
      },
